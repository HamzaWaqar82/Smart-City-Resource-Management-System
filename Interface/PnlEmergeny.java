...
public class PnlEmergeny {
    private static List<EmergencyService> emergencyList = new ArrayList<>();
    ...
    protected static JPanel createEmergenyJPanel(){
        ...
        btnAdd.addActionListener(e -> {
            try {
                ...
                EmergencyService es = new EmergencyService(id, Location, status, responseTime, unitType, numUnit);
        ...
        btnCalcCost.addActionListener(e -> {
            ...
            if (selectedRow != -1) {
                ...
                JOptionPane.showMessageDialog(panel, "Maintainence Cost: " + cost, "Maintainence Cost", JOptionPane.INFORMATION_MESSAGE);
            }else{
        ...
        btnAlert.addActionListener(e -> {
            ...
            if (selectedRow != -1) {
                ...
                JOptionPane.showMessageDialog(panel,"Emergeny Alert has been sent Successfully, see console", "Alert", JOptionPane.INFORMATION_MESSAGE);
            }else{
                JOptionPane.showMessageDialog(panel, "Select an Emrgency Service");
            }
        });
        ...
        btnLoad.addActionListener(e -> {
            Type listType = new TypeToken<List<EmergencyService>>() {}.getType();
